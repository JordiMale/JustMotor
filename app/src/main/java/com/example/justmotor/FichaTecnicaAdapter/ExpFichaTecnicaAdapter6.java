...
public class ExpFichaTecnicaAdapter6 extends BaseExpandableListAdapter {
    ...
    public ExpFichaTecnicaAdapter6(Context context, ArrayList<String> listCategoria, Map<String, ArrayList<String>> mapChill) {
