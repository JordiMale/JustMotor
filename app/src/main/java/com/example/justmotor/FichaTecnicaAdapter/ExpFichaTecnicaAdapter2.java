...
public class ExpFichaTecnicaAdapter2 extends BaseExpandableListAdapter {
    ...
    public ExpFichaTecnicaAdapter2(Context context, ArrayList<String> listCategoria, Map<String, ArrayList<String>> mapChill) {
