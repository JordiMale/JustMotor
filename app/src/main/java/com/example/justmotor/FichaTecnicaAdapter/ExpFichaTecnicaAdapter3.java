...
public class ExpFichaTecnicaAdapter3 extends BaseExpandableListAdapter {
    ...
    public ExpFichaTecnicaAdapter3(Context context, ArrayList<String> listCategoria, Map<String, ArrayList<String>> mapChill) {
