...
public class ExpFichaTecnicaAdapter5 extends BaseExpandableListAdapter {
    ...
    public ExpFichaTecnicaAdapter5(Context context, ArrayList<String> listCategoria, Map<String, ArrayList<String>> mapChill) {
