...
public class ExpCompAdapter2 extends BaseExpandableListAdapter {
    ...
    public ExpCompAdapter2(Context context, ArrayList<String> listCategoria, Map<String, ArrayList<String>> mapChill) {
